...
<?php include_once("top_right_menu.php"); ?>
	...
	<div id="feature">
      ...
      <h3>Create a Learning Object<br />from a Digital Image Portfolio</h3>
...
<input type='radio' name='outputtype' id='htmloutput' value='html' /> <label for='htmloutput'>Download as HTML</label><br />
<input type='radio' name='outputtype' id='pptoutput' value='ppt' /> <label for='pptoutput'>Download as PowerPoint</label><br />
...
?>
  ...
  <div id="left">
			<h2 class="h2main">About the Sandbox Project</h2>
