...
<?php include_once("top_right_menu.php"); ?>
	...
	<div id="feature">
	  ...
	  <h3>Using the Sandbox Tool</h3>
			<p>1) Create a <strong>public portfolio</strong> using <a href="http://dlxs.lib.wayne.edu/cgi/i/image/image-idx?c=vmc">Virtual Motor City</a> or <a href="http://dlxs.lib.wayne.edu/cgi/i/image/image-idx?xc=1;page=searchgroup;g=costumegroupic">Digital Dress</a> <br />
	2) Choose your portfolio from the selection menu below and click submit. <br />(Note: the more images you have in a portfolio, the longer it will take to generate your portfolio) <br/>
